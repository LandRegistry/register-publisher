...
export INCOMING_QUEUE_HOSTNAME="amqp://mqpublisher:mqpublisherpassword@localhost:5672//"
export INCOMING_QUEUE="system_of_record"
export OUTGOING_QUEUE_HOSTNAME="amqp://mqpublisher:mqpublisherpassword@localhost:5672//"
